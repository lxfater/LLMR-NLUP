...
import { extractHtmlCodeFromMd, getHtml, replaceElement } from '../utils';
...
const download = () => {
  const blob = new Blob([getHtml()], { type: "text/plain;charset=utf-8" });
  saveAs(blob, `${store.page.id}.html`);
}
  ...
  <div class="controlPanelContainer">
    <div class="header">
      <div class="pageAction">
        ...
        <el-tooltip class="box-item" effect="dark" content="Download Code" placement="top">
          <el-icon size="30" @click="download">
            <Download />
          </el-icon>
        </el-tooltip>
      ...
      <div class="setting">
        <el-tooltip class="box-item" effect="dark" content="Why not star this project on Github?" placement="top">
    ...
    <div class="main">
      <el-input v-model="question" :autosize="{ minRows: 5, maxRows: 5 }" type="textarea"
